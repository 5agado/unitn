...
public class ShowProductsServlet extends HttpServlet {
    ...
    private void showHtmlPage (HttpServletRequest request, HttpServletResponse response) throws IOException{
        ...
        out.println("                        <h2 class='span1'><a class='btn btn-primary btn-success' href='"+ SM_LANDING_PAGE_SELLER +"'>RETURN</a>");
        out.println("                        </h2>");
        out.println("                    </div>");
        out.println("                    <table class='table'>");
        out.println("                        <tr>");
        out.println("                            <th>Selled</th>");
        ...
        out.println("                        </tr>");
         //ciclo sulla entries della tabella
        ...
        try {
            List<Product> products = manager.getProductsBySeller(userId);
            DecimalFormat df = new DecimalFormat("0.00");
            for (Product p:products){
                out.println("                        <tr>");
                out.println("                                <td>"+ (p.isOnSale()?"":"X") +"</td>");
